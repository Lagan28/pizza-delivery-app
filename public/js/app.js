...
var cartCounter = document.querySelector('#class-counter');
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var pizza = JSON.parse(btn.dataset.pizza); //taking data from data attribute in the home.ejs Add-to-cart button
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkpizza_del_app"] = self["webpackChunkpizza_del_app"] || [];
